...
#line 125 "src/C90Parser.tab.cpp"
...
#line 183 "src/C90Parser.tab.cpp"
...
{
  "$end", "error", "$undefined", "T_VARIABLE", "T_NUMBER", "T_GT", "T_LT",
  "T_GTE", "T_LTE", "T_EQUAL", "T_NEQUAL", "T_LOR", "T_BOR", "T_LAND",
  "T_BAND", "T_BXOR", "T_SUB", "T_ADD", "T_MULT", "T_DIV", "T_MOD",
  "T_NOT", "T_ASSIGN", "T_SEMI", "T_COMMA", "T_LBRACE", "T_RBRACE",
  "T_LPAREN", "T_RPAREN", "T_INT_TYPE", "T_RETURN", "T_WHILE", "T_IF",
  "T_ELSE", "T_FOR", "$accept", "PROGRAM", "FUNCTION", "DECLARATION_LIST",
  "STAT_LIST", "DECLARATION", "STAT", "COMPOUND_STAT", "EXPRESSION_STAT",
  "SELECTION_STAT", "ITERATION_STAT", "JUMP_STAT", "EXPR",
